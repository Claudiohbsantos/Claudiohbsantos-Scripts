--[[
@description Smart Trim Left Edge
@version 1.1
@author Claudiohbsantos
@link http://claudiohbsantos.com
@date 2018 01 30
@about
  # Smart Trim Left Edge
  Trims behind item under mouse cursor, 
@changelog
  - Updated Dependency loading
@provides
	. > CS_Smart Trim Left Edge/CS_Smart Trim Left Edge.lua
	../Libraries/CS_Library.lua > CS_Smart Trim Left Edge/CS_Library.lua  
--]]
...
reaper.Undo_EndBlock2(0,"Smart Trim Left Edge",0)
reaper.PreventUIRefresh(-1)
