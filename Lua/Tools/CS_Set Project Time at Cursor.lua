--[[
@description Set Project Time at Cursor
@version 1.0
@author Claudiohbsantos
@link http://claudiohbsantos.com
@date 2018 03 08
@about
  # Set Project Time at Cursor
  Set Project Time at cursor. 
...
function onSuccess(input)
  ...
  local newOffset = input - curPos 
  if (curPos % (1/reaper.TimeMap_curFrameRate(0))) < 1/reaper.TimeMap_curFrameRate(0) - 0.001 then
   newOffset = newOffset + curPos % (1/reaper.TimeMap_curFrameRate(0))
  end
  reaper.SNM_SetDoubleConfigVar("projtimeoffs",newOffset)
end

local currentCurPos = reaper.GetCursorPosition() + reaper.GetProjectTimeOffset(0,false)
tcInputStart(currentCurPos)