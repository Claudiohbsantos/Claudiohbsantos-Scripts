--[[
@description Unselect all items with take fx
@version 1.0
@author Claudiohbsantos
@link http://claudiohbsantos.com
@date 2018 07 02
@about
  # Unselect all items with take fx
@changelog
  - Initial Release
@provides
	. > CS_Unselect all items with take fx/CS_Unselect all items with take fx.lua
	../Libraries/CS_Library.lua > CS_Unselect all items with take fx/CS_Library.lua  
--]]
...
reaper.Undo_EndBlock2(0,"Unselect all items with take fx",0)
reaper.PreventUIRefresh(-1)
